// Declaring motor pins, receiver pin, and color pins
...
void loop() {
  ...
  // irCheck is a function that holds the IR reading function and returns an int holding the sent data.
...
// Turn on the 'break' lights if the car is not moving
